/*******************************************
 ...
 each of the tty devices. It then
 creates a monitor which will report when
 tty devices are connected or removed
 from the system.
...
int main (void)
{
	...
	/* Begin polling for udev events. Events occur when devices
	   ...
	   The monitor was set up earlier in this file, and monitoring is
	   already underway.
	...
	printf("this happenes after the loop");
	udev_unref(udev);
