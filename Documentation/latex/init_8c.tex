...
\begin{DoxyCompactList}\small\item\em Recieves argc, argv from main and parses that input. \end{DoxyCompactList}\item 
...
\hline
\end{DoxyParams}
T\+O\+DO\+: Error cheking and rv\index{init.\+c@{init.\+c}!init\+\_\+geofence\+\_\+from\+\_\+argv@{init\+\_\+geofence\+\_\+from\+\_\+argv}}
...
Recieves argc, argv from main and parses that input. 
...
\end{DoxyReturn}
T\+O\+DO\+: error cheking\index{init.\+c@{init.\+c}!parse\+\_\+line@{parse\+\_\+line}}
