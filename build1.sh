...
gcc -o dist/Debug/GNU-Linux/geofence src/*.c src/serial/serialInterface.c src/pifaceCAD/cad_utils.c -LRPiGPSDemo/dist/Debug/GNU-Linux -Llog4c/lib -Ilog4c/include -Lpifacecad/libpifacecad/ -Lpifacecad/libmcp23s17/ -Ipifacecad/libpifacecad/src/ -Wl,-rpath=./RPiGPSDemo/dist/Debug/GNU-Linux -Wl,-rpath=./log4c/lib -Wall -lRPiGPSDemo -dynamic -llog4c -dynamic -lm -lpifacecad -lmcp23s17
