...
gcc -o dist/Debug/GNU-Linux/geofence src/*.c -LGPSDemo/dist/Debug/GNU-Linux -Llog4c/lib -Ilog4c/include -Wl,-rpath=./GPSDemo/dist/Debug/GNU-Linux -Wl,-rpath=./log4c/lib -Wall -lGPSDemo -dynamic -llog4c -dynamic -lm
