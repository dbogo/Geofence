...
gcc -o dist/Debug/GNU-Linux/geofence src/*.c src/serial/serialInterface.c src/pifaceCAD/cad_utils.c -LGPSDemo/dist/Debug/GNU-Linux -Llog4c/lib -Ilog4c/include -Lpifacecad/libpifacecad/ -Lpifacecad/libmcp23s17/ -Ipifacecad/libpifacecad/src/ -Wl,-rpath=./GPSDemo/dist/Debug/GNU-Linux -Wl,-rpath=./log4c/lib -Wall -lGPSDemo -llog4c -lm -lpifacecad -lmcp23s17
